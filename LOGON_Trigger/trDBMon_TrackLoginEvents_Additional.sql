/*
	...
	Date	  :	22nd June 2020
	Purpose	:	This script is to enable logon trigger and log login name, client hostname and login timestamp
	Version	:	1.0
...
*/
    BEGIN
        ...
        IF @@ROWCOUNT = 0
            BEGIN
                INSERT INTO [dbo].[tblDBMon_Track_Logins]([Login_Name], [Host_Name], [First_Login_Time], [Last_Login_Time], [Connection_Attempt_Count])
                SELECT @varLogin_Name, HOST_NAME(), @varLogin_Time, @varLogin_Time, 1
            END
    END
GO
